...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
      ...
      return {
        a: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            b: "8fb08704-3-" + i0 + "-" + i1 + "," + ("8fb08704-2-" + i0 + "-" + i1),
            c: common_vendor.p({
            ...
            f: "8fb08704-2-" + i0 + "-" + i1 + "," + ("8fb08704-1-" + i0)
          };
        }),
        b: "8fb08704-1-" + i0 + ",8fb08704-0",
        c: "8fb08704-4-" + i0 + ",8fb08704-0",
        d: common_vendor.p({
          state: {
            data,
            pagination,
    ...
    d: common_vendor.sr("udb", "8fb08704-0"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/projects/uni-app/origin_bu_yi/缘起卜一/pages/ucenter/read-news-log/read-news-log.vue"]]);
