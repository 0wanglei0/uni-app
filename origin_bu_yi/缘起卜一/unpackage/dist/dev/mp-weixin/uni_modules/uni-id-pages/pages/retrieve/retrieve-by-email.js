...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    f: common_vendor.sr("shortCode", "87a63f1a-4,87a63f1a-3"),
    ...
    v: common_vendor.sr("form", "87a63f1a-0"),
    w: common_vendor.p({
      value: $data.formData,
      ["err-show-type"]: "toast"
    }),
    x: common_vendor.sr("popup", "87a63f1a-9"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/projects/uni-app/origin_bu_yi/缘起卜一/uni_modules/uni-id-pages/pages/retrieve/retrieve-by-email.vue"]]);
