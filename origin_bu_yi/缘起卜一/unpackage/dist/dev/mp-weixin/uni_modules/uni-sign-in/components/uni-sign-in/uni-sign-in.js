...
const _sfc_main = {
  ...
  methods: {
    ...
    async showRewardedVideoAd() {
      ...
      console.log(res);
      if (res && res.length == 0) {
        let userId = common_vendor.Ds.getCurrentUserInfo().uid;
        if (!userId) {
  ...
  return {
    ...
    d: common_vendor.f($data.weekdays, (item, index, i0) => {
      return common_vendor.e({
        ...
        e: "28f948eb-2-" + i0 + ",28f948eb-0",
        f: common_vendor.p({
          color: "#FFFFFF",
          type: "closeempty"
        })
      } : {
        g: "28f948eb-3-" + i0 + ",28f948eb-0",
        h: common_vendor.p({
          type: "checkmarkempty",
          color: "#FFFFFF"
        })
    ...
    g: common_vendor.sr("popup", "28f948eb-0"),
    h: common_vendor.p({
      type: "center"
    })
  };
}
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/projects/uni-app/origin_bu_yi/缘起卜一/uni_modules/uni-sign-in/components/uni-sign-in/uni-sign-in.vue"]]);
