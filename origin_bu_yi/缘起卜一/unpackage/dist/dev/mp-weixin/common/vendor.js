...
const tabBar = {
  ...
  list: [
    {
      pagePath: "pages/zhanbu/zhanbu_grid",
...
const b = true, k = "mp-weixin", T = S([]), P = k, A = S('{\n    "address": [\n        "127.0.0.1",\n        "192.168.56.1",\n        "192.168.175.1",\n        "192.168.117.1",\n        "192.168.1.105"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/developEnvironment/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), E = S('[{"provider":"aliyun","spaceName":"origin-buyi","spaceId":"mp-c1614f28-58e5-4456-a242-9a63e35cfcfe","clientSecret":"nG88P6Ii7sIzZjh06yMttw==","endpoint":"https://api.next.bspapp.com"}]') || [];
let x = "";
try {
  x = "__UNI__F4AE6A5";
} catch (e2) {
